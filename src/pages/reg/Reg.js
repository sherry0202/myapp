    ...
    render() {
        ...
        return (
            <div style={{ backgroundColor: '#fff', height: '100%' }}>
                ...
                <WingBlank size="lg">
                    <Flex justify="center">
                        <h2 style={{ color: 'rgb(57, 55, 55)', margin: 20 }}>新用户注册</h2>
                    </Flex>
                    <WhiteSpace size="lg" />
                    <InputItem
                        clear
                    ...
                    <WhiteSpace size="lg" />
                    <Button onClick={this.regAccount} style={{ backgroundColor: '#FFA000', color: '#fff' }}>注册</Button>
                    <WhiteSpace size="lg" />
                    <Link to="/" style={{ color: '#FFA000' }}>已有账号</Link>
                </WingBlank>
